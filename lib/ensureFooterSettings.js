...
const DEFAULTS = [
  ...
  ['site_logo_url', '/images/rakushopbd-logo.png?v=8'],
...
const DEFAULT_LOGO_URL = `${DEFAULT_LOGO_PATH}?v=8`;
...
async function migrateSiteLogoUrl() {
  ...
  if (current === DEFAULT_LOGO_PATH || /^\/images\/rakushopbd-logo\.png\?v=\d+$/.test(current)) {
