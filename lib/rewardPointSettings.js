...
const DEFAULTS = {
  ...
  reward_points_min_redeem: '1',
  reward_points_max_order_percent: '50',
  reward_points_max_balance_percent: '50',
};
...
function parseRewardPointConfig(settings = {}) {
  ...
  return {
    ...
    minRedeem: readNum(settings.reward_points_min_redeem, 1, { min: 1 }),
    maxOrderPercent: readNum(settings.reward_points_max_order_percent, 50, { min: 0, max: 100 }),
    maxBalancePercent: readNum(settings.reward_points_max_balance_percent, 50, { min: 1, max: 100 }),
  };
}
